...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="ash.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">MedicalEquipment</strong></div>
        </div>
      </div>
    </div>
...
<div class="col-sm-6 col-lg-4 text-center item mb-4">
        ...
        <form method="post" action="manage_cart2.php?action=add&id=<?php echo $product['id']; ?>">
