...
<title>Pharma &mdash;Medical</title>
  <meta charset="utf-8">
...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="ash.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Medicnes</strong></div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="title-section text-center col-12">
        <h2 class="text-uppercase">Medical products available in Pharma</h2>
      </div>
    </div><br><br>
    ...
    $query = " SELECT `id`, `name`, `image`, `price` FROM `medicalpage` order by id ASC ";
...
<div class="col-sm-6 col-lg-4 text-center item mb-4">
        ...
        <form method="post" action="manage_cart.php?action=add&id=<?php echo $product['id']; ?>">
        ...
        <input type="submit" name="add_to_cart" class="btn btn-block btn-warning btn-flat" value="Add to Cart"><br>
